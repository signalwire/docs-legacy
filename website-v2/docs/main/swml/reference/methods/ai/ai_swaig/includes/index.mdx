---
slug: /swml/reference/ai/swaig/includes
...
Functions can trigger various behaviors: speaking text, sending SMS, playing audio, transferring calls, and more. See the [actions documentation](/docs/swml/reference/ai/swaig/functions/data-map#actions) for all available options.
</Tip>
